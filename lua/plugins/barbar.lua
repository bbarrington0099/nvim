...
vim.keymap.set("n", "<leader>bk", "<Cmd>BufferCloseAllButCurrentOrPinned<CR>", { desc = "Buffer Close All But Current" })
vim.keymap.set("n", "<leader>bp", "<Cmd>BufferPin<CR>", { desc = "Buffer Pin" })
vim.keymap.set("n", "<leader>br", "<Cmd>BufferMoveNext<CR>", { desc = "Buffer Move Next" })
vim.keymap.set("n", "<leader>bl", "<Cmd>BufferMovePrev<CR>", { desc = "Buffer Move Prev" })
return{}
